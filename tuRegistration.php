...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>E- Learning: Tutor reg</title>
  ...
  <body>    
    ...
    <!--=========== END HEADER SECTION ================--> 
      <font>
<form name="frm" method="post" enctype="multipart/form-data" action="tudb.php">
<div class="table"> 
<table border="1" height='500' width="350" align="center">


<tr>
<td colspan="2">Tutor Registration</td>
</tr>
...
<td><input type="text" name="con_num"></td>
</tr>
...
<td><textarea name="skill_desc"></textarea></td>
</tr>
...
<tr>
  ...
  <td><input type="file" name="adfle"></td>
</tr>
