...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>E- Learning: Tutor Change Profile</title>
...
<font>
<div class="table">
<table align="center" width="400" height="400" border="2">
<?php 
...
if (isset($_POST["Edit"])) {
   ...
   mysqli_query($conn,"update tut set Name='$uname', Password='$pass', Gender='$gender', Email='$email', Contact_no='$con', DOB='$dob', Address='$address', Skilll='$skl', Skill_description='$skl_desc' where ID='$sid'");
  mysqli_query($conn,"update login set Username='$uname', Password='$pass' where ID='$sid1'");
}

$qry=mysqli_query($conn,"select * from tut where ID='$sid'");
...
<tr>    
    <td>Contact No.</td>
    <td><input type="text" name="contact" value="<?php echo $data["Contact_no"]?>"></td>
</tr>
...
<tr>    
    <td>Adhar Card No</td>
    <td><?php echo $data["adhar_card_no"]?></td>
</tr>

<tr>    
    <td>Skill</td>
    <td><input type="text" name="skl" value="<?php echo $data["Skilll"]?>"></td>
</tr>
...
<tr>    
    ...
    <td><input type="text" name="skl_desc" value="<?php echo $data["Skill_description"]?>"></td>
</tr>


<tr>    
    <td>Image</td>
    <td><img src="img/<?php echo $data["Image"]; ?>" height="100" width="100"><br><a href="tutorpic.php?pid=<?php echo $data["ID"]; ?>"><font>Update pic</font></a></td>
</tr>
