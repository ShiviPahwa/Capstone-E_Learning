...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>E- Learning Degree : Home</title>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/icon" href="img/Loogo.png"/>
      ...
      <div class="menu_area">
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">  <div class="container">
            <div class="navbar-header">
              ...
              <!-- LOGO -->
              <!-- TEXT BASED LOGO -->
              <a class="navbar-brand" href="adindex.php">E- Learning<span>Degree</span></a>              
              <!-- IMG BASED LOGO  -->
               <!-- <a class="navbar-brand" href="adindex.php"><img src="img/logo.png" alt="logo"></a>  -->            
                     
            </div>
            <div id="navbar" class="navbar-collapse collapse">
              <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                <li class="active"><a href="adindex.php">Home</a></li>
                <li><a href="course-archive.php">Update news</a></li>
                <li><a href="My courses.php">Edit</a></li>
                <li><a href="Library.php">Library</a></li>
                <li><a href="gallery.php">Gallery</a></li>                
                <li><a href="Change profile.php">Change profile</a></li>              
                <li><a href="contact-tutor.php">Contact-tutors</a></li>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
              <div class="footer_bootomRight">
                <p>Designed by students of NIIT <a href="http://wpfreeware.com/" rel="nofollow"></a></p>
              </div>
            </div>
          </div>
        </div>
