...
<?php 
  ...
  <body>    
      ...
      <div align="center" class="menu_area">
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">  <div class="container">
            <div class="navbar-header">
              ...
              <!-- IMG BASED LOGO  -->
               <!-- <a class="navbar-brand" href="stindex.html"><img src="img/capture.jpg" alt="logo"></a>  -->            
    ...
    <?php 
      ...
      {
        $id=$_SESSION["id"];
        $q2=mysqli_query($conn,"select * from login where ID='$id'");
        $d2=mysqli_fetch_array($q2);
        $name=$d2["Username"];
        $course=$_POST["course"];
        $qry1=mysqli_query($conn,"select * from tut where Skilll='$course'");
        $data1=mysqli_fetch_array($qry1);
        $image=$data1["Image"];
        $qry=mysqli_query($conn,"insert into courses(course_name, student_name, Image) values ('$course', '$name', '$image')");
        if($qry)
        {
    ?>
      <br>
       <div align="center">
      <h1 class="margin" align="center">Successfully registered to <?php echo $course; ?></h1>
